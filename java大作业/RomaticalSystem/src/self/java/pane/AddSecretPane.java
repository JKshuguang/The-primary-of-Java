...
public class AddSecretPane extends JPanel {
	JFrame jFrame;
	JFrame lastFrame;
	 ...
	 * Create the panel.
	 */
	public AddSecretPane(JFrame lastFrame,JFrame jFrame,Dimension d, Image image) {
        super();
        //得到当前Frame
        this.jFrame = jFrame;
        this.d = d;
	...
	private void handleActionEvent() {
		...
		commitButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//写SQL
				String sql = "Insert into SecretTable values(?,?,?,?)";
				...
				SecretPane.itemPaneList.add(itemPane);
				SecretPane.center_pane.add(itemPane);
